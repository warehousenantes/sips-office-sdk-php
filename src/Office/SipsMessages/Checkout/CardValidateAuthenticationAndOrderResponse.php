...
class CardValidateAuthenticationAndOrderResponse extends SipsMessage
{
    ...
    public function setHolderAuthentRelegation(
        ?string $holderAuthentRelegation
    ): self {
    ...
    public function setHolderAuthentType(
        ?string $holderAuthentType
    ): self {
